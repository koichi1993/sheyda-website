...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-[var(--color-accent)]/20 bg-black/60 py-12 text-white/80">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mt-3 max-w-sm text-sm">
              Premium shisha, crafted cocktails, and cozy vibes in the heart of Roppongi. Follow us for events & offers.
            </p>
            ...
            <div className="mt-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-lg border border-[var(--color-accent)] bg-transparent px-3 py-2 text-sm font-semibold text-[var(--color-accent)] hover:bg-[var(--color-accent)] hover:text-black transition-colors duration-300"
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-semibold text-[var(--color-accent)]">Quick Links</h4>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-semibold text-[var(--color-accent)]">Contact</h4>
            <ul className="mt-3 space-y-2 text-sm">
              <li>
          ...
          {/* CTA */}
          <div>
            <h4 className="text-sm font-semibold text-[var(--color-accent)]">Reservations</h4>
            <p className="mt-3 text-sm">Secure your table for tonight.</p>
            <a
              href="#book"
              className="mt-3 inline-flex items-center rounded-lg border border-[var(--color-accent)] bg-transparent px-4 py-2 text-sm font-semibold text-[var(--color-accent)] hover:bg-[var(--color-accent)] hover:text-black transition-colors duration-300"
            >
              Book Now
            </a>
          </div>
        ...
        {/* Divider */}
        <div className="mt-10 border-t border-[var(--color-accent)]/20 pt-6 text-xs text-white/60">
